...
public class Assignment1{
    static class Player{
        ...
        public static void main(String[] args){
            ...
            while (n < 4 || n > 10){
                System.out.println("Invalid number 4~10");
                n = sc.nextInt();
                sc.nextLine();
            }
